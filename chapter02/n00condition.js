// if (true) console.log("사실"); // 실행문이 한줄이면 {}를 생략 가능합니다.
// if (false) {
//   console.log("거짓");
// };

//  이상의 코드의 경우 거의 사용하지 않겠습니다.
...
//  이상의 코드는 boolean 값을 변수에 대입하여 분기를 조절할 수 있습니다. 11번 라인은 open으로 실행되는 반해, 15번 라인은 동일하게 open 변수임에도 실행되지 않는다는 점에서 분기를 조절 가능합니다.
...
/*
  switch문의 ()내에는 str, number도 오는 것이 가능함.
  ...
  default이 경우에는 아무런 case에 해당되지 않을 때 실행.
